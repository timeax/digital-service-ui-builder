...
- src/react/adapters/reactflow/Canvas.tsx
- src/react/adapters/reactflow/Toolbar.tsx
- src/react/adapters/reactflow/toolbar/icons.tsx
- src/react/adapters/reactflow/toolbar/merge.ts
- src/react/adapters/reactflow/toolbar/types.ts
...
- src/react/inputs/InputWrapper.tsx
- src/react/inputs/register-custom.ts
...
```
---
`File: src/react/adapters/reactflow/adapter.ts`
```ts
...
```
---
`File: src/react/adapters/reactflow/index.tsx`
```tsx
// src/react/adapters/reactflow/index.tsx
...
```
---
`File: src/react/adapters/reactflow/Canvas.tsx`
```tsx
// src/react/adapters/reactflow/canvas.tsx
...
```
---
`File: src/react/adapters/reactflow/Toolbar.tsx`
```tsx
...
```
---
`File: src/react/adapters/reactflow/toolbar/icons.tsx`
```tsx
import React from 'react';
...
```
---
`File: src/react/adapters/reactflow/toolbar/merge.ts`
```ts
...
```
---
`File: src/react/adapters/reactflow/toolbar/types.ts`
```ts
import type {CanvasAPI} from "../../../canvas/api";
...
export class Editor {
    ...
    private loadSnapshot(s: EditorSnapshot, reason: "undo" | "redo") {
        ...
        if (canvas) {
            ...
            if (canvas.selection)
                this.api.select(Array.isArray(canvas.selection) ? canvas.selection : Array.from(canvas.selection));
        } else {
            this.api.refreshGraph();
        }
...
export * from './inputs/FormContext';
export * from './inputs/InputRegistry';
export * from './inputs/InputsProvider';
...
```
---
`File: src/react/inputs/InputWrapper.tsx`
```tsx
...
```
---
`File: src/react/inputs/register-custom.ts`
```ts
...
$colors: (
    ...
    #foreground: (
        ...
        --dark-default: #e6e7ea, // light-on-dark body text
    ),
    #card: (
        default: #ffffff,
        foreground: #0f172a,
        --dark-default: #0f172a,
        --dark-foreground: #e6e7ea,
    ),
    #popover: (
        default: #ffffff,
        foreground: #0f172a,
    ...
    #primary: (
        ...
        foreground: #ffffff,
        --dark-default: #6366f1, // indigo-500
        --dark-foreground: #ffffff,
    ),
    #secondary: (
        default: #f1f5f9, // slate-100
        foreground: #0f172a, // slate-900
        --dark-default: #1f2937, // slate-800
        --dark-foreground: #e5e7eb, // slate-200
    ),
    #muted: (
        default: #f1f5f9, // slate-100
        foreground: #64748b, // slate-500
        --dark-default: #1f2937, // slate-800
        --dark-foreground: #94a3b8, // slate-400
    ),
    #accent: (
        default: #eef2ff, // indigo-50
        foreground: #312e81, // indigo-900
        --dark-default: #334155, // slate-700 (subtle dark surface)
        --dark-foreground: #e0e7ff, // indigo-100
    ),
    #destructive: (
        default: #ef4444, // red-500
        foreground: #ffffff,
        --dark-default: #dc2626, // red-600
        --dark-foreground: #ffffff,
    ),
    #border: (
